...
func seedUser(fname, lname, email string, isAdmin bool) error {
...
func main() {
	...
	seedUser("Oliver", "Hernandez", "oliverjhernandez@gmail.com", false)
	seedUser("Admin", "Admin", "admin@default.com", true)
}
